...
public class RTCTrace extends Simulator.Watch.Empty {
	...
	private String opcode2string(int[] opcode, String currentInfusion) {
		...
		switch (opcode[0]) {
			...
			case JVM_IIFEQ: return "JVM_IIFEQ			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IIFNE: return "JVM_IIFNE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IIFLT: return "JVM_IIFLT			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IIFGE: return "JVM_IIFGE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IIFGT: return "JVM_IIFGT			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IIFLE: return "JVM_IIFLE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IFNULL: return "JVM_IFNULL		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IFNONNULL: return "JVM_IFNONNULL		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPEQ: return "JVM_IF_SCMPEQ		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPNE: return "JVM_IF_SCMPNE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPLT: return "JVM_IF_SCMPLT		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPGE: return "JVM_IF_SCMPGE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPGT: return "JVM_IF_SCMPGT		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_SCMPLE: return "JVM_IF_SCMPLE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPEQ: return "JVM_IF_ICMPEQ		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPNE: return "JVM_IF_ICMPNE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPLT: return "JVM_IF_ICMPLT		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPGE: return "JVM_IF_ICMPGE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPGT: return "JVM_IF_ICMPGT		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ICMPLE: return "JVM_IF_ICMPLE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ACMPEQ: return "JVM_IF_ACMPEQ		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_IF_ACMPNE: return "JVM_IF_ACMPNE		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_GOTO: return "JVM_GOTO			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_GOTO_W: return "JVM_GOTO_W		Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			...
			case JVM_INVOKEVIRTUAL:   referencedInfusionName=InfusionHeaderParser.getParser(currentInfusion).getReferencedInfusionName(opcode[1]); return   "JVM_INVOKEVIRTUAL " + opcode[1] + "." + opcode[2] + " Impl Infusion:" + referencedInfusionName + "    Method:" + InfusionHeaderParser.getParser(referencedInfusionName).getMethodDef_name_and_signature(opcode[2]);
			case JVM_INVOKESPECIAL:   referencedInfusionName=InfusionHeaderParser.getParser(currentInfusion).getReferencedInfusionName(opcode[1]); return   "JVM_INVOKESPECIAL " + opcode[1] + "." + opcode[2] + " Impl Infusion:" + referencedInfusionName + "    Method:" + InfusionHeaderParser.getParser(referencedInfusionName).getMethodImpl_name_and_signature(opcode[2]);
			case JVM_INVOKESTATIC:    referencedInfusionName=InfusionHeaderParser.getParser(currentInfusion).getReferencedInfusionName(opcode[1]); return    "JVM_INVOKESTATIC " + opcode[1] + "." + opcode[2] + " Impl Infusion:" + referencedInfusionName + "    Method:" + InfusionHeaderParser.getParser(referencedInfusionName).getMethodImpl_name_and_signature(opcode[2]);
			...
			case JVM_SIFEQ: return "JVM_SIFEQ			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_SIFNE: return "JVM_SIFNE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_SIFLT: return "JVM_SIFLT			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_SIFGE: return "JVM_SIFGE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_SIFGT: return "JVM_SIFGT			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
			case JVM_SIFLE: return "JVM_SIFLE			Bytecode offset:" + bytesToInt(opcode[1], opcode[2]) + " Branch target: " + bytesToInt(opcode[3], opcode[4]);
